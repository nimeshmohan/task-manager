    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-4">
      ...
      >
        ...
        <div className="rounded-2xl bg-gray-800 p-8 shadow-2xl">
          {/* Tabs */}
          <div className="mb-6 flex rounded-xl bg-gray-700 p-1">
            ...
            {mode === 'signup' && (
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-gray-600 bg-gray-700 py-2.5 pl-10 pr-4 text-sm text-white placeholder-gray-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                />
              </div>
            )}
                ...
                onKeyDown={(e) => {
                  if (e.key === 'Enter') {
                    mode === 'signin'
                      ...
                      : handle(() => signUpWithEmail(email, password, displayName))
                  }
                }}
                className="w-full rounded-lg border border-gray-600 bg-gray-700 py-2.5 pl-10 pr-4 text-sm text-white placeholder-gray-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
              />
